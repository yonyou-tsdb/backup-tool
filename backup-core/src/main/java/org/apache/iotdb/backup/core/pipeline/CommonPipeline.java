...
public class CommonPipeline implements Pipeline {
    ...
    private String getIotdbVersion(Session session) throws StatementExecutionException, IoTDBConnectionException {
        ...
        if(version.startsWith("0.13")){
            ...
            throw new IllegalArgumentException("not supported iotdb version, support version is v12 or v13");
        }
    }
